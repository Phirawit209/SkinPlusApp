  ...
  const configs = React.Children.toArray(children).reduce((acc, child) => {
    if ( /*#__PURE__*/React.isValidElement(child)) {
      ...
      if (child.type === React.Fragment || child.type === _Group.Group) {
        ...
        acc.push(...getRouteConfigsFromChildren(child.props.children, child.props.navigationKey, child.type !== _Group.Group ? groupOptions : groupOptions != null ? [...groupOptions, child.props.screenOptions] : [child.props.screenOptions]));
        return acc;
      }
    }
...
function useNavigationBuilder(createRouter, options) {
  ...
  const descriptors = (0, _useDescriptors.useDescriptors)({
    state,
    screens,
    navigation,
    screenOptions,
